...
fn main() {
    ...
    print_triplets_until(&result, 250);
}
...
/// Calculates the triplet of a Ludic number, returning `None` if `number` is
/// not the first of a triplet.
